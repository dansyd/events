...
u1 = User.create :email => 'dan@gmail.com', :dob => '1982/06/27', :sex => 'M'
u2 = User.create :email => 'mark@gmail.com', :dob => '1973/03/17', :sex => 'M'
u3 = User.create :email => 'emily@gmail.com', :dob => '1985/02/05', :sex => 'F'
